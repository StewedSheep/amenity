...
- **Always prefer using daisyUI components** for consistent, accessible, and beautiful UI elements. Use daisyUI's semantic classes (btn, card, badge, etc.) instead of manually writing Tailwind utility classes
